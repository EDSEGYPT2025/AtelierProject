    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductItems_ProductDefinitions_ProductDefinitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingRentalItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookingRentalItems_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingRentalItems_ProductDefinitions_ProductDefinitionId",
                        column: x => x.ProductDefinitionId,
                        principalTable: "ProductDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingRentalItems_ProductItems_ProductItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingRentalItems_BookingId",
                table: "BookingRentalItems",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingRentalItems_ProductDefinitionId",
                table: "BookingRentalItems",
                column: "ProductDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingRentalItems_ProductItemId",
                table: "BookingRentalItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductItems_ProductDefinitionId",
                table: "ProductItems",
                column: "ProductDefinitionId");
        }
